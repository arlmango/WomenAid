...
export function Step4Confirm({ form }: { form: RegisterFormState }) {
  return (
    <div className="space-y-4">
      ...
      <dl className="space-y-3 rounded-card border-[1.5px] border-line bg-surface-2 p-4 text-sm">
      ...
      <div className="flex items-center gap-2 rounded-card border-[1.5px] border-line bg-mint-bg p-3 text-sm text-mint-deep">
