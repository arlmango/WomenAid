// Signature ambient decoration on the warm cream background: 2-3 large
// blurred color blobs in the corners — the pitch-deck's main background
// motif. Purely decorative (pointer-events off, aria-hidden), never
